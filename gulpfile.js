 ...
 */
function buildPug() {
    return gulp.src('src/templates/**/*.pug').pipe(pug()).pipe(gulp.dest('dist/templates'))
}
...
function buildWatch() {
    ...
    gulp.watch('src/**/*.pug', { ignoreInitial: false }, buildPug);
    gulp.watch(
...
const execBuild = gulp.parallel(buildTS, buildLess, buildSASS, buildPug, copyFiles);
